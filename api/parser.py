...
class SiteParse:
    ...
    def scrab_products(self, elements, driver):
        ...
        for elem in elements:
            ...
            product_url = SITE_URL + elem.find('a', class_='tile-hover-target h2y hy3').get('href')
            product_url = product_url.split('?')[0]
            price = int(elem.find("span", class_='c3-a1 tsHeadline500Medium c3-b9').text[:-2].replace(" ", "").replace("\u2009", ""))
